import {UPSILON} from '../classes';

export const AASTHA_GINODIA = {
  firstname: 'Aastha',
  lastname: 'Ginodia',
  major: 'Economics',
  year: '2023',
